...
<ConceptCards concepts={[
  {
    term: "Wallet",
    definition: "A keypair that can sign transactions. The wallet does not store state itself. It controls which accounts can authorize changes."
  },
  {
    term: "Account",
    definition: "The basic unit of state on Solana. Accounts hold lamports, data, an owner, and metadata about how they can be changed."
  },
  {
    term: "Transaction",
    definition: "A signed message containing one or more instructions, the accounts involved, and a recent blockhash proving freshness."
  },
  {
    term: "Validator",
    definition: "A machine in the network that helps receive transactions, verify blocks, vote on outcomes, and maintain the ledger."
  }
]} />
...
flowchart LR
  A[Setup]
  B[Accounts and Lamports]
  C[Transactions]
  D[Architecture]
  E[Kit Toolkit]
  F[Investigation Challenge]
...
<QuickCheck
  id="solana-foundations-overview-goal"
  question="What is the real goal of Solana Foundations?"
  options={[
    "Memorize as many CLI commands as possible",
    "Build a trustworthy mental model for Solana state, transactions, and client interaction",
    "Deploy a production program on mainnet",
    "Learn Anchor before understanding accounts and transactions"
  ]}
  correctIndex={1}
  explanation="This module is about building the core Solana mental model first: wallets, accounts, transactions, network behavior, and a first real client toolkit. That foundation makes later lessons much easier to reason about."
/>

<QuickCheck
  id="solana-foundations-overview-debugging"
  question="When something feels unclear in this module, what question should you ask first?"
  options={[
    "Which command syntax did I forget?",
    "What changed on-chain?",
    "Which framework should I install next?",
    "How do I skip ahead to programs?"
  ]}
  correctIndex={1}
  explanation="The module keeps pushing you toward state-change reasoning. The important habit is asking what changed on-chain, not just what command you typed."
/>
...
<UpNextCard
  nextTitle="Development Environment Setup"
  nextDescription="Install the Solana CLI, create a wallet, switch to devnet, and verify your machine is ready."
  nextHref="/learn/solana-foundations/devnet-setup"
  nextReadingTime={8}
