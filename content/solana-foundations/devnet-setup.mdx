...
<QuickCheck
  question="Which cluster should you usually use for this course's hands-on exercises?"
  options={[
  ...
  correctIndex={2}
  explanation="Devnet is the default target for this course because it is public, easy to access, and gives you free test SOL for repeatable exercises. Localnet is more isolated and can be safer for fully local experiments, but this lesson is teaching the shared course workflow, which is devnet."
/>
