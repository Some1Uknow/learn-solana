---
title: "Day 2: Ownership System - The Heart of Rust"
description: "Master Rust's unique ownership system, learn about borrowing and references, and understand how Rust achieves memory safety without garbage collection."
tags: ['rust', 'ownership', 'borrowing', 'references', 'memory-safety', 'slices']
...
<MermaidWithZoom 
  ...
  chart="
    graph TD
      ...
      B1 --> B1A[✅ let r1 = &data]
      B1 --> B1B[✅ let r2 = &data]
      B1 --> B1C[✅ Many readers allowed]
      
      B2 --> B2A[✅ let r = &mut data]
      B2 --> B2B[❌ No other references]
