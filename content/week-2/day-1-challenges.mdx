...
description: "Practice Day 1 Rust with three focused exercises that force you to use variables, functions, control flow, loops, and basic input handling without guessing."
type: challenge
