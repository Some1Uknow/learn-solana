---
title: "Rust Mid-Course Projects: Portfolio Tracker and Blockchain Simulator"
description: "Apply Rust concepts from the first half with complete projects: build a crypto portfolio tracker or a simple blockchain simulator to reinforce ownership and structs."
type: project
module: "🦀 Rust for Solana"
keywords: ["rust projects", "portfolio tracker", "blockchain simulator", "ownership", "structs"]
---
...
<MermaidWithZoom
title="Crypto Portfolio Tracker Architecture"
  chart={`
graph TB
