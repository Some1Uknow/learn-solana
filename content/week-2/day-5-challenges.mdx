---
title: "Day 5 Challenges: NFT Metadata Manager & DEX Order Book"
description: "Build real-world Solana applications using collections and string processing"
---

import { MermaidWithZoom } from '@/components/fumadocs/mermaid-with-zoom';
import { Callout } from 'fumadocs-ui/components/callout';

# Day 5 Challenges: NFT Metadata Manager & DEX Order Book
