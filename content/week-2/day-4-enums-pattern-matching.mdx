---
title: "Rust Enums and Pattern Matching (Option, Result, match)"
description: "Learn Rust enums and pattern matching with practical examples, from variant data to real-world use of match, Option, and Result widely used in Solana code."
