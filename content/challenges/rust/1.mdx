...
description: "Start your Rust journey with Day 1: Learn to declare variables, understand basic types, and use println! macro for output. Perfect for Solana development beginners."
keywords:
  - "rust hello world"
  - "rust variables"
  - "rust println"
