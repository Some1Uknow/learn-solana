...
description: "Add behavior to types with impl blocks in Day 10: methods, associated functions, and self parameter. Build reusable components for Solana programs."
keywords:
  - "rust impl blocks"
  - "rust methods"
