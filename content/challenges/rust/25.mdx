...
description: >-
  Manually serialize data to bytes in Day 25: the foundation for understanding
  Borsh serialization used throughout Solana development.
keywords:
  - rust serialization
  - rust bytes
