...
description: >-
  Auto-implement traits with #[derive] in Day 23: Debug, Clone, Copy, PartialEq,
  and more. Essential macros for Solana account serialization.
keywords:
  - rust derive macro
  - rust derive traits
  - rust debug trait
