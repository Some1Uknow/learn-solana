...
description: "Store key-value pairs with HashMap in Day 14: insertion, lookup, iteration, and common patterns. Perfect for mapping accounts in Solana applications."
keywords:
  - "rust hashmap"
  - "rust key value"
