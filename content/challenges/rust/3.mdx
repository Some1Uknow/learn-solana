...
description: "Learn Rust functions in Day 3: parameters, return types, expressions vs statements, and function composition. Essential skills for writing Solana programs."
keywords:
  - "rust functions"
  - "rust parameters"
  - "rust return types"
