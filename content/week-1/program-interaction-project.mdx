...
description: This project will help you build a CLI-based toolkit that interacts directly with deployed Solana programs. You'll write TypeScript scripts using `@solana/web3.js` to query accounts, send transactions, and analyze on-chain activity, without relying on Anchor. The goal is to get comfortable with raw, lower-level Solana development.
type: project
