...
description: "Use your Week 1 toolkit to inspect real accounts, send a real transfer on devnet, and write down what changed before and after the transaction."
type: challenge
...
That is not a good Week 1 test.

A good Week 1 challenge asks a simpler question:
...
If you can do that without guessing, Week 1 is working.
