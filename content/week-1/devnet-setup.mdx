...
If those three pieces are clear in your head, the rest of Week 1 gets much easier.
...
With the CLI working, a funded devnet wallet, and a clear cluster configuration, you are ready for the rest of Week 1.
