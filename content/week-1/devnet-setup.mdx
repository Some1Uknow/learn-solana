---
title: "Solana Development Environment Setup (CLI Tools Guide)"
description: "Set up the Solana development environment: install the CLI, manage keypairs, switch clusters, verify config, and get ready to build programs."
type: setup
