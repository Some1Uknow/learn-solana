---
title: "Solana Accounts and Lamports Exercise (Hands-On)"
description: "Create wallets, transfer lamports, inspect account layout, and learn rent thresholds to build confidence with Solana accounts using the CLI."
type: exercise
