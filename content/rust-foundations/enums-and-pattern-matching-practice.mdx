...
description: "Build a Solana-style wallet manager using enums and pattern matching to handle account types, transaction states, and robust error handling."
type: challenge
...
Build a comprehensive wallet management system that handles different account types, transaction states, and error conditions. This challenge tests your understanding of enums, pattern matching, and error handling.
</Callout>
...
**Next up:** Collections and string handling, the tools you need to manage richer data structures in Rust.
